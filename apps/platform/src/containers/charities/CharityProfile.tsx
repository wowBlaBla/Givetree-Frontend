  ...
  return (
    <div className="grid grid-cols-1 gap-3 mb-2">
      ...
      <div className="max-w-layout mx-auto w-full">
        <PersonalInfo avatar={data.charity.media.tileUrl} name={data.charity.name} />
            ...
            >
              {navs.map((item, idx) => (
                <li
                  ...
                  key={idx}
                >
                  <span className="nav-link block text-lg leading-tight capitalize px-6 py-3 hover:border-b-brand-orange hover:bg-gray-100 focus:border-transparent active">
                    {item}
                  </span>
                </li>
              ))}
        ...
        <Fundraisers className="w-full my-10" />
      </div>
    </div>
  );
};
