...
export const SalesContainer: FC = () => {
  ...
  const [bidError, setBidError] = useState<IBidError>({
  ...
  return (
    <div className="w-full">
      ...
      {
        isProcessing ? <LoadingContainer message={`${isListed.type == "sale" ? "Purchasing NFT" : "Placing a bid" } . . .`}/> : ""
      }
      <div className="bid-modal">
        <input type="checkbox" id="my-modal-6" className="modal-toggle" checked={openModal} />
