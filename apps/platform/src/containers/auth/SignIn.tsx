...
export const SignIn: FC = () => {
  ...
  const { isAuth, login, requestResetPassword } = useAuth();
  ...
  const handleForgotPassword = async () => {
    const ret = await requestResetPassword(forgotEmail);
    if (ret) {
      setForgotStep(2);
    }
  };
                ...
                {forgotStep == 1 ? (
                  ...
                  <>
                    ...
                    <p className="text-center text-sm">
                      ...
                      <span className="font-bold text-black">{forgotEmail}</span>
                      <br />
                      If this email address is registered to Givetree.xyz, you'll receive
