  ...
  return (
    <div className="profile">
      <div className="p-8 max-w-layout-xl">
        <h1 className="font-bold text-black text-[24px] mb-2">Create an Collection</h1>
        <div className="flex items-center mb-[48px]">
          <RequiredIcon />
          <span className="text-sm ml-2 text-black">Required fields</span>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="">
            <MintItemTitle title="Links" />
            <div className="rounded-xl border-[1px] my-4 border-base-content bg-white">
              <div className="flex items-center p-4 border-b-[1px] border-base-content last:border-b-0 justify-between">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setCharityDonation({ ...charityDonation, address: e.target.value })
              }
            >
              ...
              {themes.map((item, idx) => (
                <div
                  className={cx(
                    ...
                    {
                      "border-sky-500 shadow-card-theme shadow-sky-500":
                        activeTheme == item.title,
                      "border-base-content hover:shadow-card-theme hover:shadow-sky-500 hover:border-sky-500":
                        activeTheme != item.title,
                    }
                  )}
                  key={idx}
                ...
                >
                  <img src={item.icon.src} className="brightness-50" />
