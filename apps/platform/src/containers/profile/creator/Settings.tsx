            ...
            <div className="flex flex-col gap-8 w-[468px]">
                ...
                <div className="input-grop">
                    ...
                    <div className="relative text-gray-600 focus-within:text-gray-400">
                        <input
                            type="password"
                            className="input input-bordered mt-1 block w-full rounded-md shadow-sm outline-none focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-12 px-4 pr-10"
                            />
