...
export const CollectionCard: FC<CollectionCardProps> = (props) => (
  <div className="relative bg-brand-black rounded-md shadow-lg overflow-hidden h-full">
    <div className="absolute top-0 right-0 text-xs sm:text-base bg-white rounded-md border border-blue-600 text-blue-600 z-20 py-1 px-2 m-2">
      Featured Launch
    </div>
    ...
    <div className="flex relative flex-col items-center -mt-16 z-50 space-y-2">
      <div className="w-12 h-12 sm:w-16 sm:h-16">
        <Image className="rounded-full" src={props.creatorImageAsset} alt={props.title} />
      </div>
