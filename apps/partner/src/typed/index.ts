...
export type GetUserQuery = {
  ...
  users_by_pk?: {
    ...
    country?: string | null;
    cryptoActivityRating?: number | null;
    cryptoConfidenceRating?: number | null;
    cryptoExperienceRating?: number | null;
    cryptoOffRampStrategy?: string | null;
    description?: string | null;
    discordUrl?: string | null;
    email?: string | null;
    ethWalletAddress?: string | null;
    expectedReleaseDate?: any | null;
    firstName?: string | null;
    id: any;
    isArtworkReady?: boolean | null;
...
export const CreateUserDocument = gql`
  mutation CreateUser(
    ...
    $expectedReleaseDate: timestamptz
    $firstName: String
